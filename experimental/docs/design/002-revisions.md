...
from the current Graph spec on the next reconcile. The applied set in the revision's status — not
the Graph — is the authoritative record of what was written to the cluster.

...
const applyHashAnnotation = "internal.kro.run/template-hash" // annotation value unchanged for backward compat
...
type cachedObject struct {
	...
	applyHash       string         // hash of the template we last applied
